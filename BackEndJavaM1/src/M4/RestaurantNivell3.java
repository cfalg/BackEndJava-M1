...
/**
 * @author Carles Falgueras - Date 30/06/2021 - BackEndJava
 * 
 *         Crea excepcions personalitzades amb fitxers nous e implementa-les al
 *         codi actual.
 *         Has de crear Excepcions personalitzades per:  Revisió de tipus,
 *         introducció de plats, revisió de plats de la comanda.
...
public class RestaurantNivell3 {
	...
	private static void demanarMenu() {
		...
		while (seguirDemanant == 1) {
			...
			} catch (RestaurantExcPlatInvalid e) {
				// Crida a la excepció personalizada que valida si el plat i és o no
	...
	private static int volsSeguirDemanant() throws RestaurantExcRevisioTipus {
...
//			}
	 ...
	 * no
	 */
	private static void validaPlat(String platDemanat) throws RestaurantExcPlatInvalid {
		...
		if (platTrobat == false) {
			throw new RestaurantExcPlatInvalid(platDemanat);
		}
